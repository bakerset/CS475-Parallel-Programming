    ...
    while (NowYear < 2030) {        
        ...
        #pragma omp parallel sections
        {
            ...
            #pragma omp section
            {
                ...
                WaitBarrier();  // DoneComputing barrier
                outputFile << "Year: " << NowYear << ", Month: " << NowMonth << endl;
                outputFile << "Temperature: " << ((NowTemp - 32.0) * 5.0 / 9.0) << "°C, Precipitation: " << (NowPrecip * 2.54) << " cm" << endl;
                outputFile << "Grain Height: " << (NowHeight * 2.54) << " cm, Number of Deer: " << NowNumDeer << ", Number of Predators: " << NowNumPredators << endl;
                NowMonth++;
                if (NowMonth == 12) {
                    NowMonth = 0;
                    NowYear++;
